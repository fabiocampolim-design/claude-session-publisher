...
41 checks, run against the synthetic session in `examples/` — self-contained,
no real transcript needed. To exercise it on a large messy conversation of your
own:
...
byte-wise, a 3,000-character line, an empty thinking block and an unresolved
tool call.
